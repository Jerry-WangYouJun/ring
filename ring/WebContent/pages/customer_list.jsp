					 ...
					 <input  class="form-control" name="id" type="hidden"></input>
						<div class="form-group">
							<label for="message-text" class="control-label">头像:</label> 
								<input type="text" class="form-control" name="headImage" id="headImage" placeholder="必填" >
						</div>
						<div class="form-group">
							<label for="recipient-name" class="control-label">审核状态:</label> <input
								type="text" class="form-control" name="examine" id="examine"  placeholder="必填" >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="message-text" class="control-label">生日:</label> 
								<div class='input-group date' id='datetimepicker1'  >  
					                <input type='text' class="form-control" readonly name="birthday"  id="birthday"/>  
						...
						<div class="form-group">
							<label for="message-text" class="control-label">现住址:</label> 
								<input type="text" class="form-control" name="addtress" id="addtress">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="message-text" class="control-label">婚姻状况:</label> 
								<input type="text" class="form-control" name="marriage" id="marriage">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<label for="message-text" class="control-label">自我介绍:</label> 
								<input type="text" class="form-control" name="introduction" id="introduction">
						</div>
						<div class="form-group">
							<label for="message-text" class="control-label">爱情宣言:</label> 
...
<script type="text/javascript">
		...
		$(function(){
			    $('#infoTable').bootstrapTable({  
			        ...
			        },{ field : 'chName',   title : '会员名',   align: 'center', valign: 'middle'  
			        },{ field : 'nickName',   title : '会员昵称',  align: 'center',   valign: 'middle'  
			        ...
			        },{ field : 'hometown',   title : '家乡',  align: 'center',   valign: 'middle'  
			        },{ field : 'marriage',   title : '婚姻状态',  align: 'center',   valign: 'middle'  ,
						formatter : function(value, row, index, field) {
							return getDicDescirb(value,field);
			        }
			        },{ field : 'telephone',   title : '联系电话',  align: 'center',   valign: 'middle'  
			        },{ field : 'examine',   title : '审核状态',  align: 'center',   valign: 'middle'  ,
						formatter : function(value, row, index, field) {
							return getDicDescirb(value,field);
